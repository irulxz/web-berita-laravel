        ...
        <form action="{{ route('tags.update', $tag->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    placeholder="Contoh: Trending, Viral, Teknologi"
                    required 
                    autofocus
                >
                ...
                <small class="text-muted d-block mt-1">
                    Tag digunakan untuk label tambahan pada berita.
                </small>
            </div>
            ...
            <div class="form-group mb-0">
                <button type="submit" class="btn btn-primary shadow-sm">
                    <i class="fas fa-save mr-1"></i> Perbarui Tag
                </button>
                <a href="{{ route('tags.index') }}" class="btn btn-secondary shadow-sm">
                    Batal
                </a>
            </div>
